...
| Companies and onboarding | Application/signature references, seven evidence stages, multiple required underwriters, formation/operating states, member interests, authority/renewal records and evidence-based launch; duplicate-company warnings on create (distinctive-name, contact, email and city reasons, never merged or blocked, exact matches acknowledged explicitly); company materials register and reviewed partner publication (see company-materials-publication.md) |
