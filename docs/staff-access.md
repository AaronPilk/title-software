...
- For an address outside the seven already approved pilot users, review its Cloudflare Access eligibility separately. An app invitation does not change the Access allowlist.
