...
- Commission an independent security review/penetration test before expanding access or selling externally. Choose SOC 2 scope/timing and any ISO 27001 requirement based on customer demands and assurance needs, then retain operating evidence. Certificates do not replace controls or legal duties.
