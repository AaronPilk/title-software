    ...
    try {
      ...
      for (const entry of entries) {
        ...
        const doc: VaultDoc = {
          ...
          name: file.name, category: entry.category, visibility: entry.visibility, date: new Date().toISOString().slice(0, 10), size: `${Math.max(1, Math.round(file.size / 1024))} KB`, version: 1, assetId: id, mime: file.type,
        };
