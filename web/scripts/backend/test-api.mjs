...
try {
  ...
  execFileSync(process.execPath, ["--test", "tests/title-api-http.test.mjs", "tests/password-setup-http.test.mjs", "tests/member-invitation-http.test.mjs"], { stdio: "inherit" });
