...
try {
  ...
  execFileSync(process.execPath, ["--test", "tests/title-api-http.test.mjs", "tests/password-setup-http.test.mjs", "tests/member-invitation-http.test.mjs", "tests/member-directory-http.test.mjs", "tests/invitation-email-http.test.mjs", "tests/staff-assignment-http.test.mjs"], { stdio: "inherit" });
