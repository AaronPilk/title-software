...
export function createFollowup(
  ...
  return traceMutation(s, "createFollowup", [orderId, input], () => {
...
export function recordFollowupSent(
  ...
  return traceMutation(s, "recordFollowupSent", [requestId, reference], () => {
