import type { HelpScreen } from "./help-guides";

export type Specialist = "Coordinator" | "Finals reviewer" | "Company coordinator" | "Month-end reviewer" | "Product guide";
...
export type AssistantContext = {
  ...
  purpose?: "help"; screen?: HelpScreen;
};
...
export type AssistantThread = {id: string; title: string; companyId: string; orderId: string; accessVersion: number; sourceIds: string[]; turns: AssistantTurn[]; purpose?: "help"};
export type AssistantInput = {action: "list" | "send" | "delete"; threadId?: string; requestId?: string; question?: string; specialists?: Specialist[]; purpose?: "help"; screen?: HelpScreen};
