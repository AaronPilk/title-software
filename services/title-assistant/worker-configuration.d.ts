/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f6ff4ad3c8632a7a1dcfb68d92b66f63)
// Runtime types generated with workerd@1.20260515.1 2026-09-13 nodejs_compat
interface __BaseEnv_Env {
	AI: Ai;
	TITLE_API_URL: "https://yhneskzvmtcmbsknidlt.supabase.co/functions/v1/title-api";
	PERSONAL_ASSISTANT: DurableObjectNamespace<import("./src/index").PersonalAssistant>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "PersonalAssistant";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TITLE_API_URL">> {}
}
