/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a3974ad472c5e7f228d5a5eb82daadf8)
// Runtime types generated with workerd@1.20260921.1 2026-09-24 nodejs_compat
interface __BaseEnv_Env {
	TITLE_SCANNER_ENABLED: "false";
	TITLE_SCANNER: DurableObjectNamespace<import("./src/index").TitleScanner>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "TitleScanner";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TITLE_SCANNER_ENABLED">> {}
}
